        ...
        SafeArea(
          child: Column(    // whole screen is considered as column
            ...
            children: [   // widgets inside the column
              ...
              // another ROW starts
              Container(    // second widget >> K(Kindergarten) and G1(Grade 1)
                child: Row( // to make the widgets in the same row
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Container(  // put inside container, to apply Inkwell >> K
                      child: 
                        InkWell(
                          onTap: () {
                            Navigator.push(context,
                            MaterialPageRoute(builder: (context) => KinderQuiz()));
                          },
                          child: 
                            Container(
                    ...
                    Container(  // put inside container, to apply Inkwell >> G1
                      child: 
                        InkWell(
                          onTap: () {
                            Navigator.push(context,
              ...
              // another ROW starts
              Padding(    // put a padding 
                padding: EdgeInsets.fromLTRB(0,30,0,30), // padding configuration
                child: Row(   // to make the widgets in the same row
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Container(  // put inside container, to apply Inkwell >> K
